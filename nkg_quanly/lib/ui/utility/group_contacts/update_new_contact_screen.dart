...
class UpdateNewContactScreen extends GetView {
  ...
  Widget build(BuildContext context) {
    ...
    String? organizationId = contactListItems.organizationId;
    String? organizationName = findNameOfOrganById(contactOrganizationViewModel.rxOrganList,organizationId!);
                    ...
                    InkWell(
                      onTap: () {
                        contactOrganizationViewModel
                            .deleteWorkBookItem(contactListItems.id!);
                        Get.back();
                      },
                      child: Align(
                              ...
                              child: StatefulBuilder(
                                builder: (context, groupWorkerStateChange) {
                                  return DropdownButton(
                                    iconSize: 0.0,
                                    value: (organizationName?.isNotEmpty == true) ?organizationName : null ,
                                    style: Theme.of(context).textTheme.headline4,
                                  ...
                                  child: ElevatedButton(
                                      onPressed: () {
                                        ...
                                        if (employeeName!.isNotEmpty ||
                                          ...
                                          contactOrganizationViewModel.updateContact(
                                              contactListItems.id!,
                                              employeeName!,
                                              position!,
                                              organizationId!,
