...
class AnalysisQuadraValueCollumChartWidget extends StatefulWidget {
  const AnalysisQuadraValueCollumChartWidget({UniqueKey? key, this.listChart})
      : super(key: key);

  final List<ChartChildItems>? listChart;

  @override
  State<StatefulWidget> createState() => AnalysisQuadraValueCollumChartState();
}

class AnalysisQuadraValueCollumChartState
    extends State<AnalysisQuadraValueCollumChartWidget> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                legendChart("Giỏi", kBlueButton),
                const Padding(padding: EdgeInsets.fromLTRB(15, 0, 0, 0)),
                legendChart("Khá", kOrange),
              ],
            ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                legendChart("Trung bình", kGreenChart),
                const Padding(padding: EdgeInsets.fromLTRB(15, 0, 0, 0)),
                legendChart("Yếu", kRedChart),
              ],
            )
          ],
        ),
