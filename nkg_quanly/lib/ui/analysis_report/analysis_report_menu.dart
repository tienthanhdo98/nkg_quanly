...
List<MenuListItem> listMenuAnalysisReport = [
  ...
  MenuListItem(
      'BC đối tượng chính sách', 'assets/icons/ic_analy_report_2.png', "", 2),
  MenuListItem('Giáo dục mầm non', 'assets/icons/ic_analy_report_3.png', "", 3),
  MenuListItem(
      'Giáo dục tiểu học', 'assets/icons/ic_analy_report_4.png', "", 4),
  MenuListItem('Giáo dục THCS', 'assets/icons/ic_analy_report_5.png', "", 5),
  MenuListItem('Giáo dục THPT', 'assets/icons/ic_analy_report_6.png', "", 6),
  MenuListItem(
      'Giáo dục khuyêt tật', 'assets/icons/ic_analy_report_7.png', "", 7),
  MenuListItem(
      'Giáo dục thường xuyên', 'assets/icons/ic_analy_report_8.png', "", 8),
  MenuListItem(
      'Quản lý chất lượng GD', 'assets/icons/ic_analy_report_9.png', "", 9),
  MenuListItem(
