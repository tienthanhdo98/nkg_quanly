...
var chatluonggd = [
  chart("Cơ cấu học sinh hoàn thành chương trình học", "2"),
  chart("Xếp hạng tỷ lệ học sinh hoàn thành chương trình theo vùng", "1"),
  chart("Xếp hạng tỷ lệ học sinh hoàn thành chương trình theo tỉnh/TP", "1"),
];
var phamchat = [
...
var khenthuong = [
  chart("Thống kê tỷ lệ HS được khen thưởng theo tỉnh, TP", "2"),
  chart("Thống kê tỷ lệ HS được khen thưởng theo vùng", "2"),
  chart("thống kê tỷ lệ HS được khen thưởng theo năm", "2"),
  chart("Thống kê tỷ lệ HS được khen thưởng theo học kỳ", "1"),
  chart("Xếp hạng vùng theo tỷ lệ HS khen thưởng", "1"),
  chart("Xếp hạng vùng theo tỷ lệ HS khen thưởng", "1"),
