                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: InkWell(
                              onTap: (){
                                Get.to(() => MissionCommentsDetail(snapshot.data!));
                              },
                              child: const Text(
                                "Xem chi tiết",
                                style: blueTextStyle,
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                  Text(
                                      commentItem.comment!,style: CustomTextStyle.roboto400s16TextStyle),
                                  const Padding(padding: EdgeInsets.fromLTRB(0, 10, 0, 0)),
                                  Text(commentItem.employeeName!,style: CustomTextStyle.robotow400s12TextStyle,)
                                ],),
                              )),
                        );
                      }),
