...
class ListAllItemEOffice extends StatelessWidget {
 ...
 final List<Childrens> listChildren;
  ...
  Widget build(BuildContext context) {
    listChildren.removeWhere((element) => element.id == "37869c39-4d28-482c-53ff-08da9b7bdabe");
    return Scaffold(
      body: SafeArea(
          child: Column(
        children: [
...
{
  var type = listEOffice.firstWhereOrNull((element) => element.id! == id)?.type!;
  var img =  listEOffice.firstWhereOrNull((element) => element.id! == id)?.img!;
  var title =  listEOffice.firstWhereOrNull((element) => element.id! == id)?.title!;
  toScreenEoffice(
      type!, title, img);
}
...
List<MenuListItem> listEOffice = [
  MenuListItem('Lịch làm việc', 'assets/icons/ic_job.png', "", 1,"e001e3de-0cdf-4e9a-9580-08da97870319"),
  MenuListItem('Văn bản đến', 'assets/icons/ic_doc_in.png', "", 2,"c58d8dd8-74d2-4abe-9581-08da97870319"),
  MenuListItem('Hồ sơ trình', 'assets/icons/ic_doc_doc.png', "", 3,"d49797df-e9b1-42ba-9582-08da97870319"),
  MenuListItem('Hồ sơ công việc', 'assets/icons/ic_hoso_cv.png', "", 4,"a0166eea-e9ed-468c-9583-08da97870319"),
  MenuListItem('Bố trí phòng họp', 'assets/icons/ic_meeting.png', "", 5,"908e233d-013d-4351-9584-08da97870319"),
  MenuListItem('Bố trí và điều động xe ô tô', 'assets/icons/ic_booking_car.png', "", 6,"90e22b1b-a263-441b-9585-08da97870319"),
  MenuListItem('Nhiệm vụ', 'assets/icons/ic_mission.png', "", 7,"2451f554-c887-4874-9586-08da97870319"),
];
