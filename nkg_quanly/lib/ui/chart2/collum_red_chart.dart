...
class ColumnRedChart2 extends StatefulWidget {
  const ColumnRedChart2({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => ColumnRed2ChartState();

}
class ColumnRed2ChartState extends State<ColumnRedChart2> {
