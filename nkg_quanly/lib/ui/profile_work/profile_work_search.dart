...
import 'e_office/profile_work_e_office_list.dart';



class ProfileWorkSearch  extends GetView {

  final searchController = Get.put(SearchController());

  ProfileWorkSearch(this.profileWorkViewModel ,{Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        searchController.rxProfileWorkList.clear();
        return true;
      },
      child: Scaffold(
        body: SafeArea(
                  ...
                  child: Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: Obx(() => (searchController.isLoading.value == false) ? ListView.builder(
                          ...
                          itemCount: searchController.rxProfileWorkList.length,
                          itemBuilder: (context, index) {
                            var item = searchController.rxProfileWorkList[index];
                            return  InkWell(
                                onTap: () {
...
Widget listProfileWorkSearchResultWidget(SearchController searchController, List list) {
        ...
        return  InkWell(
            onTap: () {
              showModalBottomSheet<void>(
                ...
                context: context,
                builder: (BuildContext context) {
                  return DetailProfileWorkBottomSheet(
                      index,
                      item);
                },
              );
