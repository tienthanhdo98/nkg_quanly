...
const apiGetMissionStatistic =
    "http://123.31.31.237:6002/api/homes/mission-statistic-state";
...
const apiGetMissionChart =
    "http://123.31.31.237:6002/api/homes/mission-statistic?missionFilter=";

//calendar work
const apiPostCalendarWork =
    "http://123.31.31.237:6002/api/homes/calendar-search?Keyword&DayInMonth=&IsMonth=&DateFrom=&DateTo=&PageIndex=1&PageSize=10";
//doc unprocess
const apitGetUnProcess0 =
    "http://123.31.31.237:6002/api/homes/documentin-unprocess?filterUnProcess=0";
const apitGetUnProcess1 =
    "http://123.31.31.237:6002/api/homes/documentin-unprocess?filterUnProcess=1";
const apiGetDocumentUnprocessFilterChart =
    "http://123.31.31.237:6002/api/homes/documentin-unprocess?filterUnProcess=";

//doc nonapprove
const apiGetDocumentNonApprove =
    "http://123.31.31.237:6002/api/homes/documentin-non-approved";
const apiGetDocumentApproveFilterChart =
    "http://123.31.31.237:6002/api/homes/documentin-non-approved?filterNonApproved=";
...
const apiGetProfileFilter =
    "http://123.31.31.237:6002/api/homes/profile-get-statistic-chart?filterChart=";
//profile work
...
const apiGetProfileProcedureChart0 =
    "http://123.31.31.237:6002/api/homes/procedureprofile-statistic-chart?filterChart=0";
const apiGetProfileProcedureChart1 =
    "http://123.31.31.237:6002/api/homes/procedureprofile-statistic-chart?filterChart=1";
...
const apiGetDocumentOutFilter0 =
    "http://123.31.31.237:6002/api/homes/documentout-search/wait-release?filterWaitRelease=0";
const apiGetDocumentOut = "http://123.31.31.237:6002/api/homes/documentout-search";
//meeting room
const apiGetMeetingroomStatistic =
    "http://123.31.31.237:6002/api/meetingrooms/statistic";
const apiPostAllMeetingroomCalendar =
    "http://123.31.31.237:6002/api/homes/meetingroom-calendar";
...
const apiGetReportChart0 =
    "http://123.31.31.237:6002/api/homes/reportapiclient-statistic-chart?filterChart=0";
const apiGetReportChart1 =
    "http://123.31.31.237:6002/api/homes/reportapiclient-statistic-chart?filterChart=1";
...
//event
const apiGetLatestEvent = "http://123.31.31.237:6002/api/homes/event-latest";
//list widget by user
const apiGetListWidget = "http://123.31.31.237:6002/api/widget/get-by-user-role";
const apiGetAllListMenu = "http://123.31.31.237:6002/api/menus/get-by-user-role";

//notification
const apiPostGetNotificationList =
    'http://123.31.31.237:6002/api/homes/notification-search';
const apiPostDeleteNotification =
    'http://123.31.31.237:6002/api/homes/notification-deletes';
const apiGetChangeAllNotificationStatus =
    'http://123.31.31.237:6002/api/homes/notification-update-all-status';
const apiGetChangeNotificationStatus =
    'http://123.31.31.237:6002/api/homes/notification-update-status?id=';
